...
// 		gcc overlaybuild.c -o overlaybuild;	./overlaybuild 128.10.25.101 30035 128.10.25.113 128.10.25.111 128.10.25.109 128.10.25.107 128.10.25.105 128.10.25.103 10024 40048

//		gcc overlaybuild.c -o overlaybuild;	./overlaybuild 128.10.25.101 30035 128.10.25.112 128.10.25.111 128.10.25.110 128.10.25.109 128.10.25.108 128.10.25.107 128.10.25.106 128.10.25.105 128.10.25.104 128.10.25.103 10024 40050
...
int main(int argc, char **argv) 
{
	...
	if(argc < 3)
	{
		printf("Usage: overlaybuild dst-IP dst-port routerk-IP ... router2-IP router1-IP overlay_port src_port \n");
		exit(1);
	}
	...
	int router_port = atoi(argv[argc-2]);
